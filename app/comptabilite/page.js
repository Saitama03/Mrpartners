      ...
      <div className="pt-20">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 text-base">
                <li>Tenue et mise à jour de la comptabilité (achats, ventes, banques)</li>
                <li>Clôture périodique et comptes annuels</li>
                <li>Déclarations de TVA et obligations connexes</li>
                <li>Tableaux de bord et reporting de gestion</li>
                <li>Conseil comptable et organisation administrative</li>
                <li>Digitalisation des pièces et processus</li>
              </ul>
            </div>
            <div>
              <div className="backgroundimg w-full h-96 rounded-xl shadow-sm" style={{ backgroundImage: "url('/accounting.png?v=1')" }}></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <h3 className="text-3xl md:text-4xl text-center text-black font-normal mb-12">Notre méthode</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <h4 className="text-xl font-semibold text-gray-800 mb-2">Prise de contact</h4>
                <p className="text-gray-600 text-sm">Analyse de votre activité et de vos obligations pour cadrer la mission.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-semibold mb-4">2</div>
                <h4 className="text-xl font-semibold text-gray-800 mb-2">Onboarding</h4>
                <p className="text-gray-600 text-sm">Mise en place des échanges, outils et routines de suivi adaptées.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
